const DebuggerDuck = ({ setDucks }) => {
  const addNewDuck = () => {
    setDucks([
      {
        id: crypto.randomUUID(),
        duckName: 'Daffy Duck',
        imgSrc: 'https://upload.wikimedia.org/wikipedia/en/f/f4/Daffy_Duck.svg',
  ...
  return (
    <section className='w-full bg-base-300 h-screen mt-[-1px] overflow-hidden flex flex-col items-center justify-center'>
      ...
      <div className='flex'>
        <button
          onClick={addNewDuck}
          className='btn btn-accent rounded mx-12 p-2 mt-8 transition-all duration-300 justify-self-end'
        >
